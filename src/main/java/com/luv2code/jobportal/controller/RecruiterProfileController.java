...
public class RecruiterProfileController {
    ...
    public String recruiterProfile(Model model){
        ...
        if(!(authentication instanceof AnonymousAuthenticationToken)){
            ...
            Users user = usersRepository.findByEmail(currentUserName)
                    .orElseThrow(()->new UsernameNotFoundException("Could not fount " +
                    "the user"));
    ...
    public String addNew(RecruiterProfile recruiterProfile
        ...
        if(!(authentication instanceof AnonymousAuthenticationToken)){
            ...
            recruiterProfile.setUsers(users);
        ...
        String uloadDir = "photos/recruiter"+savedUser.getUserAccountId();
        try{
            FileUploadUtil.saveFile(uloadDir, fileName, multipartFile);
        } catch (Exception e) {
            e.printStackTrace();
        }
